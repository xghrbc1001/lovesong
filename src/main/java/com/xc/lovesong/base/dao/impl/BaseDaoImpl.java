package com.xc.lovesong.base.dao.impl;
...
import com.xc.lovesong.base.dao.BaseDao;
...
public class BaseDaoImpl<T> extends HibernateDaoSupport implements BaseDao<T> {
	...
	public int getTotalCount(T baseBean) {
		String className = baseBean.getClass().getName();
		String hql = "select count(*) from " + className + " p where p.DELETE_FLAG = false";
		Object obj = createQuery(hql).uniqueResult();
		return ((Long) obj).intValue();
	}
